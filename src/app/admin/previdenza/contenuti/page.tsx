  ...
  return (
    <div className="p-4 md:p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-primary">Contenuti Previdenza</h1>
          <p className="text-text-muted text-sm">Testi, FAQ e contenuti sezione previdenza</p>
        </div>
      </div>
