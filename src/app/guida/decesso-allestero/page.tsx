...
export const metadata: Metadata = {
  title: "Decesso all'Estero — Guida Pratica",
  description: "Quando il decesso avviene fuori dall'Italia. Guida completa passo dopo passo su cosa fare.",
}
  ...
  return (
    <div className="min-h-screen bg-background">
      <section className="bg-primary py-20 md:py-28 relative overflow-hidden">
        <Image src="/images/guida-decesso-allestero.png" alt="" fill className="object-cover opacity-20" sizes="100vw" />
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <h1 className="font-[family-name:var(--font-serif)] text-3xl md:text-4xl text-white">Decesso all'Estero</h1>
          <p className="mt-3 text-white/90">Quando il decesso avviene fuori dall'Italia</p>
        </div>
      </section>
