...
<div className="relative max-w-4xl mx-auto px-4 text-center"><BookOpen size={36} className="mx-auto mb-3 text-secondary-light" /><h1 className="font-[family-name:var(--font-serif)] text-3xl md:text-4xl text-white">Inumazione o Tumulazione?</h1><p className="mt-3 text-white/85">Le differenze spiegate — come scegliere</p></div></section>
...
<div className="card"><h2 className="text-xl text-primary mb-3">Inumazione (sepoltura in terra)</h2><p className="text-sm text-text-light">Il cofano viene sepolto in un campo del cimitero. Concessione: 10-30 anni. Costo concessione: <strong>€300 — €2.000</strong>. Al termine, i resti vengono esumati e trasferiti in ossario.</p></div>
<div className="card"><h2 className="text-xl text-primary mb-3">Tumulazione (sepoltura in loculo)</h2><p className="text-sm text-text-light">Il cofano viene posto in un loculo murato nel muro del cimitero. Concessione: 30-50 anni o perpetua. Costo: <strong>€1.500 — €8.000</strong>. Richiede anche lapide e chiusura (€500-€2.000).</p></div>
