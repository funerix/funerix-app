...
<Image src="/images/guida-manifesto-funebre.png" alt="" fill className="object-cover opacity-20" sizes="100vw" />
<div className="relative max-w-4xl mx-auto px-4 text-center"><ScrollText size={36} className="mx-auto mb-3 text-secondary-light" /><h1 className="font-[family-name:var(--font-serif)] text-3xl md:text-4xl text-white">Il manifesto funebre</h1><p className="mt-3 text-white/85">Come scriverlo, formati, costi e dove affiggerlo</p></div></section>
