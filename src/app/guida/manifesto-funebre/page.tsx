...
<section className="bg-primary py-16"><div className="max-w-4xl mx-auto px-4 text-center"><ScrollText size={36} className="mx-auto mb-3 text-secondary-light" /><h1 className="font-[family-name:var(--font-serif)] text-4xl text-white">Il manifesto funebre</h1><p className="mt-3 text-white/85">Come scriverlo, formati, costi e dove affiggerlo</p></div></section>
