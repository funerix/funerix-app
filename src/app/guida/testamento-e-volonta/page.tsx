...
<section className="bg-primary py-16"><div className="max-w-4xl mx-auto px-4 text-center"><FileText size={36} className="mx-auto mb-3 text-secondary-light" /><h1 className="font-[family-name:var(--font-serif)] text-4xl text-white">Testamento e volontà</h1><p className="mt-3 text-white/85">Disposizioni anticipate e pianificazione</p></div></section>
